...
```{r Design 1 Simulation, include=FALSE}
...
```{r Design 2 Simulation, include=FALSE}
...
```{r}
spls_mod <- spls(sim_preds, sim_resp, K = 2, eta = 0.74)
```


```{r}
ORings <- read.csv('http://people.reed.edu/~jones/Courses/Orings.csv')
```
```{r}
